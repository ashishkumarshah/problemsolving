...
/**
* This class is used to calculate the factorial for a given number.
* This output of this class is limited only to the long range. So it cannot support factorials for large numbers.
*/
