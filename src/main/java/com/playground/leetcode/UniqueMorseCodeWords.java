 ...
 * "https://leetcode.com/problems/unique-morse-code-words/description/">leetcode
 * problem statement</a>. This class is used to calculate the number of unique
 * morse code representations of a given array of words.
 *
...
public class UniqueMorseCodeWords {
	...
	/**
	 * This method is used to retreive the unique morse code representations for the
