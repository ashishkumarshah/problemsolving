 ...
 * Please refer <a href=
 * "https://leetcode.com/problems/judge-route-circle/description/">this</a> for
 * more detail and the problem description.
 */
public class JudgeRootCircle {
	...
	/**
	 * This method is used to move the robot according to the sequence of moves
	 * given in the input. After moving it determines if the robot has reached home.
	 * 
	 * @param pMoves
